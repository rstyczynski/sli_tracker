...
#
# Run from project root with NAME_PREFIX set and state-${NAME_PREFIX}.json present in project root.
# Reads: state-${NAME_PREFIX}.json → .fn_rp_os.policy.ocid, .fn_rp_os.dynamic_group.ocid
set -euo pipefail
